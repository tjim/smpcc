...
# 96 "uECC.h"
int uECC_make_key(uint8_t p_publicKey[32*2], uint8_t p_privateKey[32]);
# 111 "uECC.h"
int uECC_shared_secret(const uint8_t p_publicKey[32*2], const uint8_t p_privateKey[32], uint8_t p_secret[32]);
# 122 "uECC.h"
void uECC_compress(const uint8_t p_publicKey[32*2], uint8_t p_compressed[32 +1]);
# 133 "uECC.h"
void uECC_decompress(const uint8_t p_compressed[32 +1], uint8_t p_publicKey[32*2]);
# 150 "uECC.h"
int uECC_sign(const uint8_t p_privateKey[32], const uint8_t p_hash[32], uint8_t p_signature[32*2]);
# 165 "uECC.h"
int uECC_verify(const uint8_t p_publicKey[32*2], const uint8_t p_hash[32], const uint8_t p_signature[32*2]);
# 14 "eccmpc.c" 2
