...
func gen_main(ios []GenVM) {

	initialize_ram(ios[0])
	...
	for !done {
		...
		go gen0(ios[1], ch0, _attsrcStateO)
		go gen1(ios[2], ch1, _attsrcStateO)
		go gen2(ios[3], ch2, _attsrcStateO, __search_left_01, __search_right_02)
		go gen3(ios[4], ch3, _attsrcStateO, __search_v_0, _attsrcMemRes)
		go gen4(ios[5], ch4, _attsrcStateO, _5, _8, __search_left_01, __search_right_02, __search_v_0)
		go gen5(ios[6], ch5, _attsrcStateO, __search___retres7_0, __search_ret_site_0)
		go gen6(ios[7], ch6, _attsrcStateO)
		go gen7(ios[8], ch7, _attsrcStateO, ___search_left_0, __search_right_0_)
		go gen8(ios[9], ch8, _attsrcStateO)
		go gen9(ios[10], ch9, _attsrcStateO)
		go gen10(ios[11], ch10, _attsrcStateO)
		go gen11(ios[12], ch11, _attsrcStateO)
		go gen12(ios[13], ch12, _attsrcStateO)
